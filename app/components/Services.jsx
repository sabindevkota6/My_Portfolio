...
const Services = () => {
  return (
    <div id= "services" className='w-full px-[12%] py-10 scroll-mt-20'>
      <h4 className='text-center mb-2 text-lg font-Ovo'>What do I offer?</h4>
      <h2 className='text-center text-5xl font-Ovo'>My Services</h2>

      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'> I provide web development services using technologies like Java, Python, HTML, CSS, JavaSctipt, React.js, Next.js, and more.
