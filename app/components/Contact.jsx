...
const Contact = () => {
  ...
  // Form submission handler - sends email via web3forms API
  ...
  return (
    ...
    dark:bg-none'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'> If you'd like to discuss a project 
        ...
        {/* Contact form - handles submission with animations */}
        <motion.form 
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
                ...
                {/* Name input with slide-in animation */}
                <motion.input 
                ...
                {/* Email input with slide-in animation from right */}
                <motion.input 
                initial={{ x: 50, opacity: 0 }}
                whileInView={{ x: 0 , opacity: 1 }}
            ...
            {/* Message textarea with slide-up animation */}
            <motion.textarea 
            ...
            dark:bg-darkHover/30 dark:border-white/90 dark:placeholder:text-white/50' name='message'></motion.textarea>
